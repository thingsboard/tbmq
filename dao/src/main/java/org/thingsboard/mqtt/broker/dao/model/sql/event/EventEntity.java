...
import static org.thingsboard.mqtt.broker.dao.model.ModelConstants.EVENT_ENTITY_ID_PROPERTY;
import static org.thingsboard.mqtt.broker.dao.model.ModelConstants.EVENT_SERVICE_ID_PROPERTY;
...
public abstract class EventEntity<T extends Event> implements BaseEntity<T> {
    ...
    public EventEntity(UUID id, UUID entityId, String serviceId, long ts) {
        this.id = id;
