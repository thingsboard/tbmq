...
class MqttPubRelHandlerTest {
    ...
    void setUp() {
        ...
        mqttPubRelHandler = spy(new MqttPubRelHandler(msgPersistenceManager, mqttMessageGenerator));
    ...
    void testProcessPersistent() {
        ...
        verify(msgPersistenceManager, times(1)).processPubRel(1, ctx);
    }
    ...
    void testProcessNonPersistent() {
        ...
        mqttPubRelHandler.process(ctx, 1);
        verify(mqttMessageGenerator, times(1)).createPubCompMsg(1);
    }
