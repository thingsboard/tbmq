...
import org.thingsboard.mqtt.broker.service.testing.integration.parent.AbstractPayloadFormatAndContentTypesIntegrationTestCase;
...
@ContextConfiguration(classes = AppPayloadFormatAndContentTypesIntegrationTestCase.class, loader = SpringBootContextLoader.class)
@DaoSqlTest
...
public class AppPayloadFormatAndContentTypesIntegrationTestCase extends AbstractPayloadFormatAndContentTypesIntegrationTestCase {
    ...
    @Test
    public void givenAppSubscribedClient_whenPubMsgWithPayloadFormatAndContentType_thenReceiveMsgWithSpecifiedProperties() throws Throwable {
        ...
        connectClientAndSubscribe(options, receivedMsg, receivedResponses);
