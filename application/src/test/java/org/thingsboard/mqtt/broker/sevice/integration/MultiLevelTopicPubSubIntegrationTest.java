...
@Slf4j
@DirtiesContext
@ContextConfiguration(classes = MultiLevelTopicPubSubIntegrationTest.class, loader = SpringBootContextLoader.class)
public class MultiLevelTopicPubSubIntegrationTest extends AbstractPubSubIntegrationTest {
    ...
    void initSubscriber(Waiter waiter, int subscriberId) {
        try {
            ...
            subClient.subscribe(MULTI_LEVEL_TOPIC, qos, (topic, message) -> {
