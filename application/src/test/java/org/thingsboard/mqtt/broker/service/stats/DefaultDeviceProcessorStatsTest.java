...
public class DefaultDeviceProcessorStatsTest {

    private DefaultDeviceProcessorStats stats;

    @Before
    public void setUp() {
        StatsFactory statsFactory = new DefaultStatsFactory(new SimpleMeterRegistry());
        stats = new DefaultDeviceProcessorStats("consumer-1", statsFactory);
    }
    ...
    public void givenPacksProcessed_whenGetAvgPackSize_thenReturnsCeilOfAverage() {
        stats.logClientIdPacksProcessingTime(3, 1, TimeUnit.MILLISECONDS);
        stats.logClientIdPacksProcessingTime(4, 1, TimeUnit.MILLISECONDS);
    ...
    public void givenReset_whenGetAvgPackSize_thenReturnsZeroNotNaN() {
        stats.logClientIdPacksProcessingTime(5, 1, TimeUnit.MILLISECONDS);
