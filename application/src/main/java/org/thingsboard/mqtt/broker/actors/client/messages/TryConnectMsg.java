...
@Slf4j
@Getter
public class TryConnectMsg implements TbActorMsg {
    private final SessionInfo sessionInfo;
    private final ConnectionRequestInfo requestInfo;

    public TryConnectMsg(SessionInfo sessionInfo, ConnectionRequestInfo requestInfo) {
    ...
    public MsgType getMsgType() {
        return MsgType.TRY_CONNECT_MSG;
    }
