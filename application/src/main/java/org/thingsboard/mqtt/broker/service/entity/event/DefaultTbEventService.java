 ...
 */
package org.thingsboard.mqtt.broker.service.entity.event;
...
public class DefaultTbEventService extends AbstractTbEntityService implements TbEventService {

    private final EventService eventService;

    @Override
    public void clearEvents(UUID entityId, EventFilter eventFilter, Long startTime, Long endTime, User currentUser) {
