...
import org.thingsboard.mqtt.broker.server.ws.MqttWsEncoder;
import org.thingsboard.mqtt.broker.server.ws.WsBinaryFrameHandler;
import org.thingsboard.mqtt.broker.server.ws.WsContinuationFrameHandler;
import org.thingsboard.mqtt.broker.server.ws.WsTextFrameHandler;
...
public class MqttWssChannelInitializer extends ChannelInitializer<SocketChannel> {
    ...
    public void initChannel(SocketChannel ch) {
        ...
        SslHandler sslHandler = context.getWssHandlerProvider().getSslHandler();
        ...
        if (log.isDebugEnabled()) {
            log.debug("[{}] Created WSS channel for IP {}.", handler.getSessionId(), ch.localAddress());
        }
    }
