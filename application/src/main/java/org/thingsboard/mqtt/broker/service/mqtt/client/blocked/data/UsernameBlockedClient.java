...
public class UsernameBlockedClient extends AbstractBlockedClient {
    ...
    public UsernameBlockedClient(String username) {
        super();
        this.username = username;
    }

    public UsernameBlockedClient(long expirationTime, String description, String username) {
    ...
    public BlockedClientType getType() {
        return BlockedClientType.USERNAME;
    }
