...
public class IpAddressBlockedClient extends AbstractBlockedClient {
    ...
    public IpAddressBlockedClient(String ipAddress) {
        super();
        this.ipAddress = ipAddress;
    }

    public IpAddressBlockedClient(long expirationTime, String description, String ipAddress) {
    ...
    public BlockedClientType getType() {
        return BlockedClientType.IP_ADDRESS;
    }
