...
@Data
public class DevicePersistedMsgsRateLimitsConfiguration {
    ...
    private static class OnEnabledCondition implements Condition {
        @Override
        public boolean matches(ConditionContext context, AnnotatedTypeMetadata metadata) {
            return context.getEnvironment().getProperty("mqtt.rate-limits.device-persisted-messages.enabled", Boolean.class, false);
        }
    }
}
