...
public class ClientSessionEventActorManagerImpl implements ClientSessionEventActorManager {
    ...
    @Override
    public void sendSessionClusterManagementMsg(String clientId, SessionClusterManagementMsg msg) {
        clientMqttActorManager.processSessionClusterManagementMsg(clientId, msg);
    }
}
