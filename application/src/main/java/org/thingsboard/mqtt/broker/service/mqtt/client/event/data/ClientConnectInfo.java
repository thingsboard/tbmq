...
public class ClientConnectInfo {
    ...
    public static ClientConnectInfo fromCtx(ClientSessionCtx ctx) {
        return new ClientConnectInfo(ctx.getMqttVersion().name(), ctx.getAuthDetails());
    }

    public static ClientConnectInfo defaultInfo() {
        return new ClientConnectInfo(MqttVersion.MQTT_3_1_1.name(), WS_SYSTEM_MQTT_CLIENT_CREDENTIALS_NAME);
    }
}
