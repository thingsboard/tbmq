...
@Data
@Component
@ConfigurationProperties(prefix = "queue.kafka.integration-downlink.mqtt")
public class MqttIntegrationDownlinkKafkaSettings extends AbstractIntegrationDownlinkKafkaSettings {
