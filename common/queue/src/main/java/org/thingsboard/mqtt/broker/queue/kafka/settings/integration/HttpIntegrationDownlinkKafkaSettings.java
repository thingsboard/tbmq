...
@Data
@Component
@ConfigurationProperties(prefix = "queue.kafka.integration-downlink.http")
public class HttpIntegrationDownlinkKafkaSettings extends AbstractIntegrationDownlinkKafkaSettings {
