...
public interface EventStorageService {
    ...
    default void persistLifecycleEvent(UUID id, ComponentLifecycleEvent lcEvent, Exception e) {

    }

    default void persistStatistics(UUID id, IntegrationStatistics statistics) {

    }

    default void persistError(UUID id, ErrorEvent event) {
