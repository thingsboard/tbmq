...
public interface IntegrationContextProvider {
    ...
    default IntegrationContext buildIntegrationContext(IntegrationLifecycleMsg lifecycleMsg) {
        return null;
    }

    default IntegrationContext buildIntegrationContext(Integration integration, BasicCallback callback) {
        return null;
    }
